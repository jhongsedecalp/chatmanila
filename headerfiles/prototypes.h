...
//CR_STRUCT init_career_init args((void));
...
void	  check_promotion args((UR_OBJECT user));
void	  choose_career args((UR_OBJECT user));
void	  do_promotion args((UR_OBJECT user));
...
void	  write_room_level args((int level, int above, int record, char *str, UR_OBJECT user, RM_OBJECT room));
void	  write_room_level_except args((int level, int above, int record, char *str, UR_OBJECT user, RM_OBJECT room, UR_OBJECT except));
void      write_level_between args((int level, int level2, int record, char *str, UR_OBJECT user));
void      write_level args((int level, int above, int record, char *str, UR_OBJECT user));
void      write_level_except args((int level, int above, int record, char *str, UR_OBJECT user, UR_OBJECT except));
void      vwrite_room args((RM_OBJECT rm,char *str,...));
void      write_room args((RM_OBJECT rm,char *str));
void      vwrite_room_except_both(RM_OBJECT, UR_OBJECT, UR_OBJECT, char *, ...);
void      write_room_except_both(RM_OBJECT, char *, UR_OBJECT, UR_OBJECT);
...
void	  shout_to args((UR_OBJECT user, char *inpstr));
void      nshout args((UR_OBJECT user, char *inpstr));
void      tell args((UR_OBJECT user, char *inpstr));
void      reply args((UR_OBJECT user, char *inpstr));
void      wiz_tell args((UR_OBJECT user, char *inpstr));
void      think_it args((UR_OBJECT user, char *inpstr));
void      think_to args((UR_OBJECT user, char *inpstr));
void      sthink args((UR_OBJECT user, char *inpstr));
void      sthink_to args((UR_OBJECT user, char *inpstr));
void      sing_it args((UR_OBJECT user, char *inpstr));
void	  sing_to args((UR_OBJECT user, char *inpstr));
void      ssing args((UR_OBJECT user, char *inpstr));
void      ssing_to args((UR_OBJECT user, char *inpstr));
...
void	  shout_echo args((UR_OBJECT user, char *inpstr));
...
void      set_attributes args((UR_OBJECT user, char *inpstr, int xtraops));
...
void      arrest args((UR_OBJECT user, char *inpstr));
...
void      toggle_shoutban args((UR_OBJECT user));
...
void      cls_all args((UR_OBJECT user));
void      assasin_user args((UR_OBJECT user));
...
// Atmospherics stuff
int       ran args((int ranamnt));
void      check_atmos args((void));
int       save_atmos args((RM_OBJECT room));
void      atmos_assign args((RM_OBJECT room));
void      edit_atmos args((UR_OBJECT user, char *inpstr));
int       load_atmos args((RM_OBJECT room));

//kill stuff
void       kill_user args((UR_OBJECT user, char *inpstr));
void       list_kills args((UR_OBJECT user));

//wiz rev & topic lock
void	  record_wiz args((char *str));
void	  revwiz args((UR_OBJECT user));
void	  clear_wiz args((void));
void	  topic_lock args((UR_OBJECT user));

void      taxi_user args((UR_OBJECT user, char *inpstr));

void 	  watcher args((UR_OBJECT user, char *inpstr));
void	  watchuser args((UR_OBJECT user, char *inpstr));
/* Backslash */
void      bot_go args((UR_OBJECT bot));
void      bot_trigger args((UR_OBJECT user, char *inpstr, int allrooms));
void      bot_desc args((UR_OBJECT bot, char *inpstr));
void      bot_tell args((UR_OBJECT bot, char *inpstr));
void      bot_list_triggers args((UR_OBJECT user));
void      bot_desc args((UR_OBJECT bot, char *inpstr));
void      set_bot_stats args((UR_OBJECT bot, char *inpstr));
void      set_bot_iophrase args((UR_OBJECT bot,int mode, char *inpstr));
void      bot_load args((UR_OBJECT user,int unload));
void      bot_load args((UR_OBJECT user,int op));
void      bot_help args((UR_OBJECT user));
void      bot_file args((UR_OBJECT user,int op));
void      bot_ctrl args((UR_OBJECT user, char *inpstr));
